...
<h3>간단한 세팅.</h3>
<p>
	필자의 이전 포스트인 <a href="/posts/2018/06/11/react-ssr-next-js">"React의 SSR Framework인 Next.js로 간단하게 프로젝트 생성하기(Node.js Express)"</a> 글을 참고한 사람이라면 거기서 시작해도 상관 없다.
...
<p>
	...
	간단한 프로젝트 생성에 관해서는 위에서도 언급한 필자의 <a href="/posts/2018/06/11/react-ssr-next-js">직전 포스트</a>를 참고한다면 좋을 것이다.
</p>
...
<p>
	...
	(아래 화면과 관련된 코드의 자세한 내용은 <a href="/posts/2018/06/11/react-ssr-next-js">전 글</a>에서 확인 가능합니다.)
